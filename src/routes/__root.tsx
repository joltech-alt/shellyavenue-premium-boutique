...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-display text-2xl">Esta página no cargó</h1>
        <p className="mt-2 text-sm text-muted-foreground">
  ...
  head: () => ({
    meta: [
      ...
      { title: "SHELLY AVENUE | Moda de USA, elegida para ti" },
      {
        name: "description",
        content:
          "Ropa y accesorios originales traídos de USA para mujeres en Perú. Envíos a todo el país y pago por Yape.",
      },
      { property: "og:site_name", content: "SHELLY AVENUE" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#C43A63" },
    ],
    links: [
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Store",
          name: "SHELLY AVENUE",
          slogan: "Moda de USA, elegida para ti.",
          areaServed: "PE",
        }),
      },
    ],
